...
class ChatInterface:
    ...
    def chat_completion(self, messages, **kwargs):
        """Calls model's API and returns the natural language response

        Args:
            messages (str): Input text written by the user
        ...
        if model in config.OPENAI_API_MODELS:
        ...
        if model in config.HF_API_MODELS:
...
def extract_competency_questions(onto_verbalisation: str,
    ...
    competency_questions = chat_interface.chat_completion(
        conversation_history, model=config.DEFAULT_MODEL)
    
    print(competency_questions)
